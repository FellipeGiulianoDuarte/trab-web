                    ...
                    <div class="league-item">
                        <div class="league-info">
                            ...
                            <?php endif; ?>
                                ...
                                <form action="backend/league_logic/leave_league.php" method="POST" style="display: inline;" onsubmit="return confirm('Tem certeza que deseja sair desta liga?');">
                ...
                <?php while ($league = $leagues_result->fetch_assoc()): ?>
                    <div class="league-item">
                        ...
                        <div class="league-actions">                            <?php if ($league['is_member'] > 0): ?>
                                ...
                                <form action="backend/league_logic/join_league.php" method="POST" class="join-form" onsubmit="return confirm('Tem certeza que deseja entrar nesta liga?');">
                                    <input type="hidden" name="league_id" value="<?php echo $league['id']; ?>">
